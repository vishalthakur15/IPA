angular.module('ui.bootstrap.datetimepicke', ["ui.bootstrap.dateparser", "ui.bootstrap.datepicker", "ui.bootstrap.timepicker"])
        ...
        controller: ['$scope', '$attrs',
          function ($scope, $attrs) {
            ...
            $scope.changedValueHour = function(item) {
                $rootScope.hourTime=item;
              } 
            $scope.changedValueMinute = function(item) {
                $rootScope.minuteTime=item;
              }*/ 
